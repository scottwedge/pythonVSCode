...
gulp.task('compile-webviews', async () => {
    ...
    // await spawnAsync('npm', ['run', 'webpack', '--', '--config', './build/webpack/webpack.datascience-ui-nativeEditorChunked.config.js'], webpackEnv);
    ...
    // await spawnAsync('npm', ['run', 'webpack', '--', '--config', './build/webpack/webpack.datascience-ui-plotViewerChunked.config.js'], webpackEnv);
    // await spawnAsync('npm', ['run', 'webpack', '--', '--config', './build/webpack/webpack.datascience-ui.config.js'], webpackEnv);
});
...
gulp.task('webpack', async () => {
    ...
    await buildWebPack('production', ['--config', './build/webpack/webpack.datascience-ui.config.js'], webpackEnv);
