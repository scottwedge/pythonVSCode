...
import { INativeCellProps, INativeCellState, NativeCell } from '../../datascience-ui/native-editor/nativeCell';
import { NativeEditor } from '../../datascience-ui/native-editor/nativeEditor';
import { IKeyboardEvent } from '../../datascience-ui/react-common/event';
import { ImageButton } from '../../datascience-ui/react-common/imageButton';
import { DataScienceIocContainer } from './dataScienceIocContainer';
import { addCell, createNewEditor, getNativeCellResults, openEditor, runMountedTest, setupWebview } from './nativeEditorTestHelpers';
...
suite('DataScience Native Editor', () => {
    ...
    suite('Editor Keyboard tests', () => {
        ...
        //         // simulateKeyPressOnCell(testItem.cellIndexToPressKeysOn, { code: testItem.keyCode });
        //         const event = createKeyboarEventForCell({ code: 'ArrowDown' });
        ...
        //         console.log(wrapper.find('div[id="cell-table-body"]').first().html());
        //         break;

        //         // Confirm cell is where we expect it to be.
        //         // verifyCellIndex(wrapper, 'div[id="NotebookImport#0"]', testItem.expectedIndex);
        //     }
        // });
